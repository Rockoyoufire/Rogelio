package com.lionsquare.annca.internal.configuration;
...
public final class AnncaConfiguration {
    ...
    public interface Arguments {
        String REQUEST_CODE = "com.example.annca.request_code";
        String MEDIA_ACTION = "com.example.annca.media_action";
        String MEDIA_QUALITY = "com.example.annca.camera_media_quality";
        String VIDEO_DURATION = "com.example.annca.video_duration";
        String MINIMUM_VIDEO_DURATION = "com.example.annca.minimum.video_duration";
        String VIDEO_FILE_SIZE = "com.example.annca.camera_video_file_size";
        String FLASH_MODE = "com.example.annca.camera_flash_mode";
        String FILE_PATH = "Chat";
    }
